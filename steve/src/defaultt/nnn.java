...
public class nnn {
 ...
 if ((choice >= 1 && choice <= 5) && (choice1 >=1 && choice1 <=5)) {
        		   if ((choice == 1 && choice1 == 1) ||(choice == 1 && choice1 == 2) || (choice == 1 && choice1 == 3) || (choice == 1 && choice1 == 4) || (choice == 1 && choice1 == 5) 
        			|| (choice == 2 && choice1 == 1) || (choice == 2 && choice1 == 3) || (choice == 2 && choice1 == 4) || (choice == 2 && choice1 == 5)
        			|| (choice == 3 && choice1 == 1) || (choice == 3 && choice1 == 2) || (choice == 3 && choice1 == 4) || (choice == 3 && choice1 == 5)
        			|| (choice == 4 && choice1 == 1) || (choice == 4 && choice1 == 2) || (choice == 4 && choice1 == 3) || (choice == 4 && choice1 == 5)
        			|| (choice == 5 && choice1 == 1) || (choice == 5 && choice1 == 2) || (choice == 5 && choice1 == 3) || (choice == 5 && choice1 == 4))
        	{	
        		...
        		else if ((choice == 3) == (choice1 == 3)) {
        			System.out.println(""+ s3);
        			System.out.println("\n" + s3);}
        		
        		  if ((choice == 5) ^ (choice1 == 5)) {
                		System.out.println( "" + s5);}
        		  else if ((choice == 5) == (choice1 == 5)) {
          			System.out.println(""+ s5);
          			System.out.println("\n" + s5);}
